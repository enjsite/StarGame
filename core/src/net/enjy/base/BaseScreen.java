...
import net.enjy.math.MatrixUtils;
...
public abstract class BaseScreen implements Screen, InputProcessor {
    ...
    public void resize(int width, int height) {
        ...
        screenBounds.setSize(width, height); // ширина и высота экрана
        screenBounds.setLeft(0); // смещаем начало координат в левый нижний угол
        screenBounds.setBottom(0); // смещаем начало координат в левый нижний угол
    ...
    public boolean touchDown(int screenX, int screenY, int pointer, int button) {
        ...
        // вектор touch в координатах картинки
